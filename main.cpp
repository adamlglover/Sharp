...
void buildExe() {
    ...
    executable << (char)0x05; executable << mi64_tostr(SET_Ei(i, op_NOP));
    executable << (char)0x05; executable << mi64_tostr(SET_Di(i, op_MOVI, 0), ebx);
    executable << (char)0x05; executable << mi64_tostr(SET_Di(i, op_MOVI, 10000000), ecx);
    executable << (char)0x05; executable << mi64_tostr(SET_Di(i, op_MOVL, 2));
    executable << (char)0x05; executable << mi64_tostr(SET_Di(i, op_MOVI, 1), egx);
    executable << (char)0x05; executable << mi64_tostr(SET_Di(i, op_NEW, egx));
    executable << (char)0x05; executable << mi64_tostr(SET_Di(i, op_MOVL, 2));
    executable << (char)0x05; executable << mi64_tostr(SET_Di(i, op_MOVI, 0), adx);
    executable << (char)0x05; executable << mi64_tostr(SET_Di(i, op_CHECKLEN, adx));
    executable << (char)0x05; executable << mi64_tostr(SET_Ci(i, op_MOV, adx,0, 1));
    executable << (char)0x05; executable << mi64_tostr(SET_Di(i, op_MOVBI, 53723), 687697862);
    executable << (char)0x05; executable << mi64_tostr(SET_Ci(i, op_MOVX, egx,0, adx));
    executable << (char)0x05; executable << mi64_tostr(SET_Di(i, op_INC, ebx));
    executable << (char)0x05; executable << mi64_tostr(SET_Ci(i, op_LT, ebx,0, ecx));
    executable << (char)0x05; executable << mi64_tostr(SET_Di(i, op_MOVI, 10), adx);
    executable << (char)0x05; executable << mi64_tostr(SET_Ei(i, op_BRE));
    executable << (char)0x05; executable << mi64_tostr(SET_Ei(i, op_RET));
