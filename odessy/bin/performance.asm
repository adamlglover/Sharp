...
[0x10c] 268:	inc sp
[0x10d] 269:	movsl #0
[0x10e] 270:	new_class @11 // std#Integer
[0x10f] 271:	movi #9, ebx
[0x111] 273:	pushr ebx
[0x112] 274:	call @64 // <std#Integer.Integer(var)>
[0x113] 275:	call @52 // <std#List.add(dynamic object)>
[0x114] 276:	iframe
[0x115] 277:	movl 8
[0x116] 278:	pushref
[0x117] 279:	inc sp
...
[0x119] 281:	inc sp
[0x11a] 282:	movsl #0
[0x11b] 283:	new_class @11 // std#Integer
[0x11c] 284:	movi #10, ebx
[0x11e] 286:	pushr ebx
[0x11f] 287:	call @64 // <std#Integer.Integer(var)>
[0x120] 288:	call @52 // <std#List.add(dynamic object)>
[0x121] 289:	iframe
[0x122] 290:	movl 8
[0x123] 291:	pushref
[0x124] 292:	inc sp
...
[0x126] 294:	inc sp
[0x127] 295:	movsl #0
[0x128] 296:	new_class @11 // std#Integer
[0x129] 297:	movi #22, ebx
[0x12b] 299:	pushr ebx
[0x12c] 300:	call @64 // <std#Integer.Integer(var)>
[0x12d] 301:	call @52 // <std#List.add(dynamic object)>
[0x12e] 302:	iframe
[0x12f] 303:	inc sp
[0x130] 304:	iframe
[0x131] 305:	inc sp
...
[0x135] 309:	movl 8
[0x136] 310:	pushref
[0x137] 311:	movi #0, ebx
[0x139] 313:	pushr ebx
[0x13a] 314:	call @57 // <std#List.get(var)>
[0x13b] 315:	movsl #0
[0x13c] 316:	check_cast 11 // std#Integer
[0x13d] 317:	pushref
[0x13e] 318:	call @66 // <std#Integer.getValue()>
[0x13f] 319:	call @65 // <std#Integer.toString(var)>
[0x140] 320:	call @40 // <std#System.print(std#string)>
[0x141] 321:	iframe
[0x142] 322:	inc sp
[0x143] 323:	movsl #0
[0x144] 324:	newstr @13
[0x145] 325:	call @2 // <application#Main.print(var[])>
[0x146] 326:	movi #32, ebx
[0x148] 328:	_putc ebx
[0x149] 329:	movr adx, sp
[0x14a] 330:	smov ebx+0
[0x14b] 331:	put ebx
[0x14c] 332:	ret
...
[0x2b] 43:	sizeof ebx
[0x2c] 44:	pushr ebx
[0x2d] 45:	call @50 // <std#Array.copyOf(dynamic object[],var)>
[0x2e] 46:	movl 0
[0x2f] 47:	movn #0
[0x30] 48:	popref
[0x31] 49:	ret

func:@53 [std#List.add] in file: src/std/List.sharp:16:11: note:  
...
func:@54 [std#List.addAll] in file: src/std/List.sharp:39:14: note:  
...
func:@55 [std#List.addAll] in file: src/std/List.sharp:62:14: note:  
...
func:@56 [std#List.clear] in file: src/std/List.sharp:66:13: note:  
		    fn clear() {
		            ^
...
func:@57 [std#List.get] in file: src/std/List.sharp:70:11: note:  
...
func:@58 [std#List.remove] in file: src/std/List.sharp:74:14: note:  
		    fn remove( var pos ) {
		             ^
...
func:@59 [std#List.set] in file: src/std/List.sharp:78:11: note:  
...
func:@60 [std#List.size] in file: src/std/List.sharp:83:12: note:  
		    fn size() : var 
		           ^
...
func:@61 [std#List.subList] in file: src/std/List.sharp:88:15: note:  
...
func:@62 [std#List.getArray] in file: src/std/List.sharp:93:16: note:  
